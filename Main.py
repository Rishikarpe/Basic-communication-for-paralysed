...
CEF_COUNTER = 0
TOTAL_BLINKS = 0
UP_DOWN_THRESHOLD = 5  # Adjust this threshold for up-down detection
# constants
CLOSED_EYES_FRAME = 3
...
with map_face_mesh.FaceMesh(min_detection_confidence=0.5, min_tracking_confidence=0.5) as face_mesh:
    ...
    while True:
        ...
        if results.multi_face_landmarks:
            ...
            # Up-Down detection
            vertical_eye_movement = (left_coords[1][1] + right_coords[0][1]) / 2 - (left_coords[4][1] + right_coords[8][
                1]) / 2
            if vertical_eye_movement > UP_DOWN_THRESHOLD:
                utils.colorBackgroundText(frame, 'Looking Up', FONTS, 1.0, (40, 420), 2, utils.WHITE, utils.BLUE, 8, 8)
            elif vertical_eye_movement < -UP_DOWN_THRESHOLD:
                utils.colorBackgroundText(frame, 'Looking Down', FONTS, 1.0, (40, 420), 2, utils.WHITE, utils.BLUE, 8, 8)
